...
#hvlt
cmpst_hvlt <- select(cmpst_all, patient_id, tx_text, site, gender, visit, hvlt_immed, hvlt_discrim) 
...
concat <- rbind(sum_stat(cmpst_madrs), sum_stat(cmpst_ham24tot), sum_stat(cmpst_panas_pos), sum_stat(cmpst_panas_neg), sum_stat(cmpst_dssi_si), sum_stat(cmpst_dssi_ss), sum_stat(cmpst_dssi_is), sum_stat(cmpst_dssi_net))


concat$name <- c("madrs", "madrs", "hamd", "hamd", "pos_affect", "pos_affect", "neg_affect", "neg_affect", "dssi_si", "dssi_si", "dssi_ss", "dssi_ss", "dssi_is", "dssi_is", "dssi_net", "dssi_net")
...
concat2 <- rbind(sum_stat(cmpst_hvlt_immed), sum_stat(cmpst_hvlt_discrim))

sum_stat(cmpst_hvlt_immed)
```

```{r}
write_xlsx(concat,"/Users/rachellee/Google Drive/Practicum/Meeting7/wk9change.xlsx")
```
