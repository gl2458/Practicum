...
plot_longitudinal <- function(x_arg , y ) {
  ...
  mmse_tot <- cmpst_tot$mmse_tot
    ...
    print( ggplot(cmpst_tot, aes(visit, y)) + geom_point(size = 0.1) + theme(axis.text.x = element_text(size=3), axis.text.y = element_text(size=3), strip.text = element_text(size=3)) +
    theme(
...
ggplot(cmpst_mmse, aes(x = mmse_tot, y = ham24tot_x )) + geom_point() + facet_grid(~tx_text_x)
