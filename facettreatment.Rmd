...
plot_longitudinal <- function(x_arg , y ) {
  ...
  mmse_tot <- cmpst_tot$mmse_tot
    ...
    print( ggplot(cmpst_tot, aes(visit, y)) + geom_point(size = 0.5) + theme(axis.text.x = element_text(size=3), axis.text.y = element_text(size=3), strip.text = element_text(size=3)) +
    theme(
